...
import { isFollowUpRole } from "@/lib/auth/roles";

export function FollowUpGuard({ children }: { children: React.ReactNode }) {
  ...
  const isFollowUp = isFollowUpRole(user?.roles);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] px-4 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md">
          هذه الصفحة مخصصة لموظفي قسم المتابعة فقط. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع الإدارة.
        </p>
