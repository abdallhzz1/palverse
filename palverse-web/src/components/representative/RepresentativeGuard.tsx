...
import { isRepresentativeRole } from "@/lib/auth/roles";

export function RepresentativeGuard({ children }: { children: React.ReactNode }) {
  ...
  const isRepresentative = isRepresentativeRole(user?.roles);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] px-4 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md">
          هذه الصفحة مخصصة لمناديب المبيعات فقط. إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع الإدارة.
        </p>
