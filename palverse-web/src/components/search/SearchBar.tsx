        ...
        >
          <div className="border-b border-[#E2EAE5] bg-[#F7F9F8] p-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <label className="relative flex min-w-0 items-center rounded-xl border border-[#E2EAE5] bg-white px-2 py-2 sm:px-3">
                <MapPin className="ml-1.5 h-3.5 w-3.5 shrink-0 text-[#6B8578] sm:ml-2 sm:h-4 sm:w-4" />
                <select
                  value={city}
                  onChange={(e) => {
                  ...
                  className="w-full min-w-0 cursor-pointer appearance-none truncate border-none bg-transparent pe-4 text-xs font-medium text-[#1A3D32] outline-none sm:text-sm"
                >
                ...
                <ChevronDown className="pointer-events-none absolute left-2 h-3.5 w-3.5 text-[#6B8578] sm:left-3 sm:h-4 sm:w-4" />
              </label>
              ...
              <label className="relative flex min-w-0 items-center rounded-xl border border-[#E2EAE5] bg-white px-2 py-2 sm:px-3">
                ...
                <select
                  ...
                  className="w-full min-w-0 cursor-pointer appearance-none truncate border-none bg-transparent pe-4 text-xs font-medium text-[#1A3D32] outline-none disabled:opacity-50 sm:text-sm"
                >
              ...
              <label className="relative flex min-w-0 items-center rounded-xl border border-[#E2EAE5] bg-white px-2 py-2 sm:px-3">
                <Tag className="ml-1.5 h-3.5 w-3.5 shrink-0 text-[#6B8578] sm:ml-2 sm:h-4 sm:w-4" />
                <select
                  value={category}
