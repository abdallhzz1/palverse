...
export default function FollowUpNewOfferPage({ params }: { params: Promise<{ publicId: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await followUpStoresService.createOffer(resolvedParams.publicId, payload);
