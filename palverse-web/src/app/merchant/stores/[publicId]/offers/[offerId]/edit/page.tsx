...
export default function EditOfferPage({ params }: { params: Promise<{ publicId: string; offerId: string }> }) {
  ...
  useEffect(() => {
    merchantService.getOffer(resolvedParams.publicId, resolvedParams.offerId)
      .then(offer => {
        setFormData({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await merchantService.updateOffer(resolvedParams.publicId, resolvedParams.offerId, payload);
