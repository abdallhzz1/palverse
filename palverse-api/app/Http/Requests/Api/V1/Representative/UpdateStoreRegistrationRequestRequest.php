...
class UpdateStoreRegistrationRequestRequest extends FormRequest
{
    ...
    {
        return [
            'zone_public_id' => ['nullable', 'string', 'exists:zones,public_id'],
            'city_public_id' => ['nullable', 'string', 'exists:cities,public_id'],
            'category_public_id' => ['nullable', 'string', 'exists:categories,public_id'],
            
            'proposed_merchant_name' => ['nullable', 'string', 'max:255'],
            'proposed_merchant_phone' => ['nullable', 'string', 'max:30'],
