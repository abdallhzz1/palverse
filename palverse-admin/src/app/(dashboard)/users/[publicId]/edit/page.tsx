  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-foreground dark:text-white">تعديل بيانات المستخدم</h2>
          <p className="text-sm text-muted-foreground dark:text-muted-foreground mt-1">تحديث البيانات الأساسية للمستخدم</p>
        </div>
      </div>
