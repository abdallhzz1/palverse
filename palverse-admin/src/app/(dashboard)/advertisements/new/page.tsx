    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-muted-foreground">إعداد إعلان ممول لمتجر ليعرض في الصفحة الرئيسية</p>
        </div>
      </div>
              ...
              [
                {
                  ...
                  title: "إبراز المتجر",
                  desc: "يظهر كبطاقة متجر مميزة في الرئيسية",
                },
                {
                  value: "banner",
                  title: "بنر إعلاني تصويري",
                  desc: "تصميم يظهر في مساحة الشريك المميز",
                },
              ] as const
            ).map((option) => (
              <label
