  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div>
          <h2 className="text-lg font-semibold text-foreground">التواصل الاجتماعي</h2>
          <p className="text-sm text-muted-foreground">روابط الحسابات الرسمية على منصات التواصل الاجتماعي</p>
        </div>
